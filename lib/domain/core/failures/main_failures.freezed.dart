...
MainFailure _$MainFailureFromJson(Map<String, dynamic> json) {
  switch (json['runtimeType']) {
    case 'clientFailure':
      return _ClientFailure.fromJson(json);
    case 'serverFailure':
      return _ServerFailure.fromJson(json);

    default:
      throw CheckedFromJsonException(json, 'runtimeType', 'MainFailure',
